 ...
 */
export declare const create: <T>(storage: API) => (key: string, defaultValue?: T | undefined) => [value: T | null | undefined, setValue: (value?: T | null | undefined) => void];
/**
 *
 ...
 */
export declare const useMMKVStorage: <T>(key: string, storage: API, defaultValue?: T | undefined) => [value: T | null | undefined, setValue: (value?: T | null | undefined) => void];
