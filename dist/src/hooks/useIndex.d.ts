 ...
 */
export declare const useIndex: <T>(keys: string[], type: DataType, storage: API) => [values: (T | null | undefined)[], update: (key: string, value?: T | null | undefined) => void, remove: (key: string) => void];
